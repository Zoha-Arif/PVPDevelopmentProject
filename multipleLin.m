...
for t = 1:length(tractIDs)
    ...
    %plotting the model
    plotAdjustedResponse(mdl, 'Age', 'MarkerEdgeColor', markerColor, 'MarkerFaceColor', markerColor) 
    legend('', 'Fit');
    ...
    rsqTableAdj.MultLin(t) = mdl.Rsquared.Adjusted;
    rsqTableOrd.MultLin(t) = mdl.Rsquared.Ordinary;
